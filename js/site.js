  ...
  initUI = function(silks) {
    ...
    symSlider = initSlider('#sym-num-rotations', {
      ...
      if (state.symNumRotations > 1) {
        $('#sym-num-rotations-label').html("" + state.symNumRotations + "-katlı dönme simetrisi.");
      } else {
        $('#sym-num-rotations-label').html("Rotasyonel simetri yok. ");
      }
  ...
  $((function(_this) {
    return function() {
      ...
      b.shareUrlEmail = ko.computed(function() {
        ...
        return "mailto:?subject=" + (escape('Cev2 -- Etkileşimli üretken sanat.')) + "&body=" + (escape('I just drew this on weavesilk.com: ' + url));
      });
      ...
      b.shareUrlFacebook = ko.computed(function() {
        ...
        return "https://www.facebook.com/dialog/feed?app_id=408271179236250&link=" + (escape(url)) + "&picture=" + (encodeURI(b.shareUrlThumbnail())) + "&name=" + 'Cev2 – Etkileşimli üretken sanat' + "&caption=" + (escape('weavesilk.com')) + "&description=" + (encodeURI('Create beautiful flowing art with Silk.')) + "&redirect_uri=" + (encodeURI(url));
      });
